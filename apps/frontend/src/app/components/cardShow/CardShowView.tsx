/**
 * CardShowView Component
 * 
 * Interactive Convention Floor and Vendor Marketplace for Pokemon TCG cards.
 * Features an interactive floor map grid, vendor catalog browsers, real-time market value arbitrage,
 * cash & card trade-in negotiation, and live auction links.
 */

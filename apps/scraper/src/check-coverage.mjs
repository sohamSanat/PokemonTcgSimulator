...
const PRICE_CHARTS = join(ROOT, 'data', 'Japanese-PriceCharts');
const JA_PRICES = join(ROOT, 'apps', 'frontend', 'public', 'ja-card-prices.json');
const EN_PRICES = join(ROOT, 'apps', 'frontend', 'public', 'en-card-prices.json');
